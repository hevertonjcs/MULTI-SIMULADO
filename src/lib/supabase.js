...
// Supabase credentials defined here serve as a fallback only. In production, environment variables
// should be used to override these values.
...
// Read Supabase credentials from environment variables (e.g. .env or Vercel environment).
